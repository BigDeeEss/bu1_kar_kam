...
class RRoundedRectangleBorder extends OutlinedBorder {
  /// Creates a rounded rectangle border.
  ///
  /// The arguments must not be null.
  const RRoundedRectangleBorder({
  ...
  ShapeBorder scale(double t) {
    return RRoundedRectangleBorder(
      side: side.scale(t),
  ...
  ShapeBorder? lerpFrom(ShapeBorder? a, double t) {
    assert(t != null);
    if (a is RRoundedRectangleBorder) {
      return RRoundedRectangleBorder(
  ...
  ShapeBorder? lerpTo(ShapeBorder? b, double t) {
    assert(t != null);
    if (b is RRoundedRectangleBorder) {
      return RRoundedRectangleBorder(
  ...
  /// Returns a copy of this RRoundedRectangleBorder with the given fields
  /// replaced with the new values.
  @override
  RRoundedRectangleBorder copyWith({ BorderSide? side, BorderRadiusGeometry? borderRadius }) {
    return RRoundedRectangleBorder(
      side: side ?? this.side,
  ...
  void paint(Canvas canvas, Rect rect, { TextDirection? textDirection }) {
    print('RRoundedRectangleBorder, paint, 1');
    switch (side.style) {
      case BorderStyle.none:
        print('RRoundedRectangleBorder, paint, 2');
        break;
      case BorderStyle.solid:
        print('RRoundedRectangleBorder, paint, 3');
  ...
  bool operator ==(Object other) {
    if (other.runtimeType != runtimeType)
      return false;
    return other is RRoundedRectangleBorder
        && other.side == side
  ...
  @override
  String toString() {
    return '${objectRuntimeType(this, 'RRoundedRectangleBorder')}($side, $borderRadius)';
  }
}
...
class _RoundedRectangleToCircleBorder extends OutlinedBorder {
  ...
  @override
  String toString() {
    return 'RRoundedRectangleBorder($side, $borderRadius, ${(circleness * 100).toStringAsFixed(1)}% of the way to being a CircleBorder)';
  }
}