...
class SettingsPageListTileSixBorder extends OutlinedBorder {
  const SettingsPageListTileSixBorder({
  ...
  @override
  SettingsPageListTileSixBorder copyWith(
      {BorderSide? side, BorderRadiusGeometry? borderRadius, Rect? guestRect}) {
    return SettingsPageListTileSixBorder(
      side: side ?? this.side,
