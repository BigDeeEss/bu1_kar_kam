...
import 'package:kar_kam/settings_page_list_tile_border_six.dart';

class SettingsPageListTileSix extends StatelessWidget {
  const SettingsPageListTileSix({Key? key}) : super(key: key);
      ...
      builder: (BuildContext context, double value, __) {
        return Container(
          ...
          child: Material(
            key: UniqueKey(),
            child: ListTile(
              shape: SettingsPageListTileSixBorder(
